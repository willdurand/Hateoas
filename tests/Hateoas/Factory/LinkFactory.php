...
use Hateoas\Factory\LinkFactory as TestedLinkFactory;
use Hateoas\UrlGenerator\CallableUrlGenerator;
use Hateoas\UrlGenerator\UrlGeneratorRegistry;
use Symfony\Component\ExpressionLanguage\ExpressionLanguage;
use tests\TestCase;

class LinkFactory extends TestCase
{
    ...
    public function testRouteRequiresGenerator()
    {
        ...
        $linkFactory = new TestedLinkFactory($expressionEvaluator, $urlGeneratorRegistry);
    ...
    private function createLinkFactory()
    {
        ...
        return new TestedLinkFactory($expressionEvaluator, $urlGeneratorRegistry);
    }
}
